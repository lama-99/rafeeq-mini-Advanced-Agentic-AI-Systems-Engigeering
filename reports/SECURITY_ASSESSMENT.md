...
- New synthetic case | الحالة الاصطناعية الجديدة: `{"asset": "customer_order_data", "case_id": "L-SEC-LAMA-01", "control": "customer_scope_validation", "expected_flag": "cross_customer_request", "payload_length": 62}`
...
- Assessment run ID | معرّف التقييم: `run-61255a3b42c24bd2`
